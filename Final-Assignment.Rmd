...
#Please note that this code has occasionally crashed and failed to locate an element that is present. If this happens, please run the code again. 
...
Census Data for Northern Ireland: 
...
Census Data for Scotland (table builder): https://www.scotlandscensus.gov.uk/search-the-census#/topics
